...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    maka = rg.SimpleTurtle()
    maka.pen = rg.Pen('brown',5)
...
def try_methods_and_functions():
    ...
    soul = rg.SimpleTurtle()
    soul.pen = rg.Pen('blue',5)

    soul.backward(150)
    soul.speed = 1
    draw_many_squares(soul,2,100,30)

    soul.speed = 5
    soul.pen = rg.Pen('red',5)
    draw_many_squares(soul,10,50,15)

    soul.speed = 100
    soul.pen = rg.Pen('red',35)
    draw_many_squares(soul,8,300,60)

    soul.pen = rg.Pen('black',3)
