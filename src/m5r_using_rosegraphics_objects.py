...
#            window3 = rg.RoseWindow(1500,100)
#
...
#            it draws all objects that have been attached to a specified window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            when we want to keep a window open until a user clicks on the window. Perhaps we wish to view the data on screen for as long as we need, then close it when ready.
#
